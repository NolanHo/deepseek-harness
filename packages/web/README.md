...
| [`web-search-bocha/`](web-search-bocha/README.md) | Provides web search through Bocha | registers on `ctx.web` |
| [`web-search-brave/`](web-search-brave/README.md) | Provides web search through Brave | registers on `ctx.web` |
| [`web-search-zhihu/`](web-search-zhihu/README.md) | Provides Zhihu station/global search | registers on `ctx.web` |
| [`web-search-academic/`](web-search-academic/README.md) | Provides academic search through arXiv + Semantic Scholar | registers on `ctx.web` |
