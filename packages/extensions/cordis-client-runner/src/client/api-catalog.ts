...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'SessionPromptOptions',
    declaration: 'export interface SessionPromptOptions {\n    readonly rewriteFrom?: number;\n}',
  },
  {
