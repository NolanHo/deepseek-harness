...
export const zh = {
  ...
  'settings.enter.title': '繁忙时发送行为',
  'settings.enter.description': '仅在智能体运行时生效；插话发送进入当前轮次，排队发送等当前轮次结束后执行',
...
export const en = {
  ...
  'settings.enter.description': 'Busy only; steer enters the running turn, queue runs after it completes',
