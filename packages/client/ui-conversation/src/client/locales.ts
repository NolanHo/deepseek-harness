...
export const zh = {
  ...
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  'chat.fold.toggle': '展开或折叠本轮过程',
  'chat.fold.collapsed': '已折叠 {parts}',
  'chat.fold.tools': '{tools} 次工具调用',
  'chat.fold.steps': '{steps} 条中间回复',
  'chat.fold.generic': '已折叠 {count} 条过程',
...
export const en = {
  ...
  'chat.fold.toggle': 'Expand or collapse this turn’s intermediate steps',
  'chat.fold.collapsed': 'Collapsed · {parts}',
  'chat.fold.tools': 'Tool calls: {tools}',
  'chat.fold.steps': 'Intermediate replies: {steps}',
  'chat.fold.generic': 'Collapsed {count} steps',
