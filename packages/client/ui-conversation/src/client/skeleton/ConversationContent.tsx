 ...
 * Held in ConversationContent it re-rendered the body — the loaded transcript
 * window and the composer stack — on every keystroke, so per-keystroke work grew
...
function InputDockSlot({ session, renderSlot, useInput }: {
  ...
  readonly renderSlot: ConversationContentProps['renderSlot']
  readonly useInput: ConversationContentProps['useInput']
}) {
