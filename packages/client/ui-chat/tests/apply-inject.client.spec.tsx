...
async function bench(initialSettings?: ChatSettings, withBrowserRegistry = true, withProcessGroups = true) {
  ...
  runtime.remote.provideNamespaces({ session: { openWorkspacePath, canOpenWorkspacePath } })
  ...
  return {
    ...
    layout, openWorkspacePath, canOpenWorkspacePath, sidebarRight, sidebarRightTabs, session, chatViewApi, rootReference, openSession,
  }
}
