...
export const ChatNodeSeat = memo(function ChatNodeSeat({
  ...
  const processWindowReady = processSpec !== undefined
    ...
    // Fork patch (FORK_SURFACE.md): upstream also requires `!historyIncomplete`
    // here, which suppresses the fold until every page is loaded; the 8-message
    // page keeps `hasMore` true for nearly every real session.
