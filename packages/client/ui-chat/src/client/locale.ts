...
export const zh = {
  ...
  'fileOpen.desktopUnavailable': '当前主机没有桌面环境，无法直接打开文件',
  ...
  'message.turnProcess.collapsed': '已折叠 {parts}',
...
export const en = {
  ...
  'fileOpen.desktopUnavailable': 'This host has no desktop environment to open the file in',
  ...
  'message.turnProcess.collapsed': 'Collapsed {parts}',
  'message.turnProcess.separator': ' · ',
