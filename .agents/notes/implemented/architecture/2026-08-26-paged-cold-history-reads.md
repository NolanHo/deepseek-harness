...
- **Widen by re-estimating from the page's message density** instead of halving: rejected — halving is monotone, bounded by log2(end/estimate) reads, and needs no per-backend statistics.
