...
flowchart LR
  ...
  pkg_web_search_academic --> svc_web
  pkg_web_search_bocha --> svc_web
  pkg_web_search_brave --> svc_web
  pkg_web_search_deepseek --> svc_web
  pkg_web_search_exa --> svc_web
  pkg_web_search_perplexity --> svc_web
  pkg_web_search_zhihu --> svc_web
...
| `ctx.web` | `seam` | [`web`](../packages/web/web) | [`web-search-exa`](../packages/web/web-search-exa), [`web-search-perplexity`](../packages/web/web-search-perplexity), [`web-search-deepseek`](../packages/web/web-search-deepseek), [`web-search-bocha`](../packages/web/web-search-bocha), [`web-search-brave`](../packages/web/web-search-brave), [`web-search-zhihu`](../packages/web/web-search-zhihu), [`web-search-academic`](../packages/web/web-search-academic), [`web-fetch-http`](../packages/web/web-fetch-http) | [`tool-web`](../packages/web/tool-web) | - | 搜索和抓取提供方注册到同一个 ctx.web seam；tool-web 负责稳定的面向模型名称。 |
