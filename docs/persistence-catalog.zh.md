...
| `persona` | 可选 | `string` |
| `provider` | 必需 | `string` |
| `skillFilter` | 可选 | [`ToolRestriction`](#persistence-type-sha256-3cfc3a56502da1f8c6153c2c56657bab4b749056968634dd0991d325ec1c919f) |
...
| `id` | 必需 | `string` |
| `role` | 必需 | `"developer"` |
| `source` | 必需 | [`MessageSource`](#persistence-type-sha256-8b36fcf017038dade9f345acd2d8afbb81a18baa1afb47f060c5bcbe98e49dc5) |

消息源兼容策略：`source` — `session-source-attribution` v1; `session.developer-message.source`; `kind`; `preserve`.

仅表示归属的新增 kind：`tmux-context`, `turn-continuation`.
...
| `turn-continuation` | `"catalog"` | 无 | [`{ kind: "turn-continuation", form: "catalog" }`](#persistence-type-sha256-4c8800c46fd673c2cf816e90c0d656d051769a2e439a89610e6750cd3f12a10a) |
| `turn-continuation` | `"instructions"` | 无 | [`{ kind: "turn-continuation", form: "instructions" }`](#persistence-type-sha256-a14bf6b0a590473e8d0c85280feb2eaa82afc389e41e572865c022934f491291) |
...
| `turn-continuation` | `"recall"` | 无 | [`{ kind: "turn-continuation", form: "recall" }`](#persistence-type-sha256-26a6221002732d6bd2c91e2936bf4be9fc07933145ee378f79fe6249cc1ed96e) |
| `turn-continuation` | `"relay"` | 无 | [`{ kind: "turn-continuation", form: "relay" }`](#persistence-type-sha256-bd5a24a1394caccec719958892a5b59d3ebe90c691078a6cd694422df0a36f60) |
...
| `turn-continuation` | 未声明 | 无 | [`{ kind: "turn-continuation" }`](#persistence-type-sha256-e1a6a79ebd73fd5c02f85469c25bc13aa8936a02015dd282dc9fb3a9e3de811e) |
...
[`Message`](#persistence-type-sha256-33bacbc0081a34be0ae68bf8021eeafc36c6c9f8968d04211419bfae37e65f27) 的数组。
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-d40e743f65a10ba907ce15ff08aab151d5a52b230caa8a5992373898a56c35c3) |
...
来源：[`packages/subagent/subagent/src/descriptor.ts:101`](../packages/subagent/subagent/src/descriptor.ts)
...
来源：[`packages/core/tools/src/index.ts:699`](../packages/core/tools/src/index.ts) · [`packages/subagent/subagent/src/types.ts:148`](../packages/subagent/subagent/src/types.ts)
...
[`UserMessage`](#persistence-type-sha256-cef3b85b84b52b367a18b777f252c66410cdb7d6b49de3a836b5cec5821e159b) 的数组。
...
来源：[`packages/api/session-controller/src/types.ts:416`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:20`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:20`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:32`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:8`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/schedule/schedule/src/types.ts:12`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`DeveloperMessage`](#persistence-type-sha256-fd849a6f563e32958efa2acd01476d0f4325d2970e976c8efb892fbf4cd02af3) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-322f6e67b4b1c1d584425c55550b7a9277df58e897efab6f85f958386d9971be) |
| `outcome` | 可选 | `"canceled"` |
...
来源：[`packages/api/session-controller/src/types.ts:421`](../packages/api/session-controller/src/types.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-a363fe14f50e49254ffe8a1f23b1901e679cef50b01bc9379ba667b8e574fcb4) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-591225c68cdb64706c53963bcbcd6cdcf3e1f4fe0e281c9a23caccc14cbd808e) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-72dd7bc3467611d63ff0c95a2e18876067d34d704522c9eb66689f411cb2e1bc) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SubagentDescriptorData`](#persistence-type-sha256-503ac79ff723b836d306cf36753368e11496c35c9f0b2e557abc9e5b69f105a7) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-cef3b85b84b52b367a18b777f252c66410cdb7d6b49de3a836b5cec5821e159b) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
